...
![](/image/大数据02/大数据02_006.jpg)
![](/image/大数据02/大数据02_007.jpg)

#### MapReduce

MapReduce主要是先读取文件数据，然后进行Map处理，接着Reduce处理，最后把处理结果写到文件中
![](/image/大数据02/大数据02_008.png)
![](/image/大数据02/大数据02_009.png)
![](/image/大数据02/大数据02_010.png)
